                ...
                {options?.map((option, index) => (
                    ...
                    >
                        <Image
                            ...
                            width={500}
                            height={120}
                            className={`object-cover h-[70px] lg:h[130px] xl:h-[180px] rounded-lg p-1 hover:border border-gray-400 cursor-pointer ${option.name === selectedStyle && 'border'}`}
                        />
